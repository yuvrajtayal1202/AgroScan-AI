        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="space-y-8">
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto">
              Detect plant diseases instantly with 99.9% accuracy. Protect your
              crops, maximize yields, secure the future.
            </p>

            <div className="flex flex-col sm:flex-row gap-6 justify-center mt-12">
              <a href="#section-upload" rel="noopener noreferrer">
                <Button
                  size="lg"
              ...
              <Button
                variant="outline"
                size="lg"
                className="border-green-400 text-green-400 hover:bg-green-400/10 text-lg px-12 py-4"
              >
            ...
            {[
              {
                ...
                description:
                  "Take a clear photo of your plant showing any concerning areas or symptoms",
              },
              {
                icon: Search,
                title: "2. AI Analysis",
                description:
                  "Our advanced AI analyzes your image against thousands of plant disease patterns",
              },
              {
                icon: FileCheck,
                title: "3. Get Report",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Advanced features designed for modern farmers and plant
              enthusiasts
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                icon: Crop,
                title: "All Crops",
                description: "500+ plant species supported",
                stat: "500+",
              },
            ].map((feature, index) => (
              <Card
      ...
      <section id="about" className="py-24 bg-green-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-green-200 leading-relaxed mb-8">
            At AgroScan, we believe that technology can revolutionize
            agriculture. Our mission is to empower farmers and gardeners
            worldwide with accessible, accurate plant disease detection tools
            that help protect crops, reduce pesticide use, and ensure food
            ...
            {[
              {
                ...
                content:
                  "AgroScan saved my tomato crop! Detected early blight before I even noticed symptoms. The treatment recommendations were spot-on.",
                rating: 5,
              },
              {
                name: "Sarah Chen",
                ...
                content:
                  "As a beginner gardener, AgroScan has been invaluable. It's like having a plant expert in my pocket!",
                rating: 5,
              },
              {
                name: "Robert Patel",
                ...
                content:
                  "Incredible accuracy and speed. AgroScan has become an essential tool for our commercial operations.",
                rating: 5,
              },
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-green-200">
                    123 AgTech Drive, San Francisco, CA 94105
                  </span>
                </div>
              </div>
              ...
              <CardContent className="p-6">
                <form className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="firstName" className="text-green-200">
                        First Name
                      </Label>
                      <Input
                        id="firstName"
                    ...
                    <div>
                      <Label htmlFor="lastName" className="text-green-200">
                        Last Name
                      </Label>
                      <Input
                        id="lastName"
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      className="min-h-[120px] bg-green-700 border-green-600 text-white"
                    />
                  </div>
                  <Button
                    type="submit"
